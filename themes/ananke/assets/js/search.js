...
function executeSearch(searchQuery){
  $.getJSON( indexURL, function( data ) {
    ...
    if(result.length > 0){
      ...
      $('#search-results').append("<div class=\"text-center mx-auto\"><img loading=\"lazy\" class=\"img-fluid mb-5\" src=\"https://user-images.githubusercontent.com/37659754/64060567-7cece400-cbf0-11e9-9cf9-abac3543ec1f.png\"><h2>Non ho trovato niente</h2></div>");
    }
  });
}
